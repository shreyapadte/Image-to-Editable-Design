...
for tp in types:
    ...
    images_output_folder_path = os.path.join("dataset", "images", tp)
    error_output_folder_path = os.path.join("dataset", "error", tp)
    maps_output_folder_path = os.path.join("dataset", "maps", tp)
    labels_output_folder_path = os.path.join("dataset", "labels", tp)
